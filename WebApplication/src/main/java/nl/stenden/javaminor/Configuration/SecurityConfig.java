...
import nl.stenden.javaminor.security.JWTFilter;
import nl.stenden.javaminor.security.JWTProvider;
import nl.stenden.javaminor.security.UnauthenticatedHandler;
import nl.stenden.javaminor.security.UserAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        enableRESTAuthentication(http).authorizeRequests().anyRequest().hasRole("USER").and().csrf().disable();
    }
